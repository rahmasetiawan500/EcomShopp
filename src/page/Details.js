...
import { Container, Left, Button, Icon, Text, Content, View} from 'native-base';
        ...
        <Content>
          ...
          {/* x bagian headers x */}
            ...
            <View>
                ...
                <Image source={require('../images/red1.png')} />
                </View>
                <View style={{alignItems:"center"}}>
                <View style={{flex: 1, flexDirection: 'row', paddingTop:140}}>
                <Icon style={{fontSize:30, color:'#E43223' ,paddingLeft:5}} type='MaterialCommunityIcons' name='circle-slice-8' />
                ...
                <Icon onPress={()=>{Actions.detailsdua()}} style={{fontSize:30, color:'#846AB2' ,paddingLeft:5}} type='MaterialCommunityIcons' name='circle-slice-8' />
